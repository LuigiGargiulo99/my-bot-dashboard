...
export function RiskModal({ isOpen, currentRisk, currentDrawdown, equity, activePreset, presets, onApply, onApplyDrawdown, onClose, loading = false }) {
  ...
  }, [isOpen, currentRisk, currentDrawdown]);
  ...
  const pctFromDollar = (usd) => eq > 0 ? (usd / eq) * 100 : 0;
    ...
    <div className="fixed inset-0 z-[60] flex items-end justify-center">
      ...
      <div className="relative bg-zinc-900 rounded-t-3xl w-full max-w-md border-t border-zinc-800 animate-slide-up flex flex-col" style={{ maxHeight: '85dvh' }}>
        ...
        <div className="px-6 pt-4 pb-6 shrink-0 safe-area-bottom">
          <button
            onClick={handleApply}
            disabled={loading || (!riskChanged && !ddChanged)}
